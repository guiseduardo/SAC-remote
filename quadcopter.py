...
#        tau = np.array([self.quads[key]['L']*np.sqrt(2)*(self.quads[key]['m1'].thrust-self.quads[key]['m2'].thrust-self.quads[key]['m3'].thrust+self.quads[key]['m4'].thrust),
#                        self.quads[key]['L']*np.sqrt(2)*(self.quads[key]['m1'].thrust+self.quads[key]['m2'].thrust-self.quads[key]['m3'].thrust-self.quads[key]['m4'].thrust),
#                        self.b*(-self.quads[key]['m1'].thrust+self.quads[key]['m2'].thrust-self.quads[key]['m3'].thrust+self.quads[key]['m4'].thrust)])
